...
int cur_type;//current enter item's type
...
void return_menu()
{
    if(in_flag==false)//out of setting mode
    {
        if(back_page)
        {
            item_pos = prev_pos;
...
/**************************end****************************/
    ...
    MenuItem item9 = MenuItem("01 Treble",1,5,4,1,32,64,0);
    MenuItem item10 = MenuItem("02 Bass",2,5,4,2,16,32,0);
    MenuItem item11 = MenuItem("03 Balance",3,5,4,3,25,50,0);
